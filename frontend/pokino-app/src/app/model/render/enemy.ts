...
export class enemy{
 ...
 constructor(Pokemon: Pokemons){
     ...
     if(Pokemon == Pokemons.Pikachu){
         material = new THREE.MeshBasicMaterial({map: loader.load('../../assets/images/pikachu.png'), transparent: true, alphaTest: 0.5});
     }
     if(Pokemon == Pokemons.Shiggy){
        material = new THREE.MeshBasicMaterial({map: loader.load('../../assets/images/squirtle_probably_copyrighted.png'), transparent: true, alphaTest: 0.5});
    }
     ...
     this.m_enemyBody = new enemyPhysicsObject(50,50, new THREE.Vector2(this.m_mesh.position.x, this.m_mesh.position.y));
 }
